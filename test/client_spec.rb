...
describe Client do
  ...
  describe 'should return results for' do
    ...
    it 'fifteenth page with colors' do
      ...
      expect(client.retrieve({page: 15, colors: ["red", "blue", "brown"]})).to eq expected
    end
  ...
  it 'should return results filtered by multiple colors' do
    ...
    expect(client.retrieve({page: 1, colors: ['red', 'blue']})).to eq expected
  end

  it 'should return results filtered by a single dominant_colors' do
    ...
    expect(client.retrieve({colors: ["brown"]})).to eq expected
  end

  it 'should return empty results' do
    expected = {"previousPage":null,"nextPage":null,"ids":[],"for_sale":[],"soldPrimaryCount":0};
    expect(client.retrieve({colors: ["hotpink"]})).to eq expected
  end
